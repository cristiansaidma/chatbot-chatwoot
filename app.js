...
const hola = require('./flows/hola')
const asesor = require('./flows/asesor')
const pasos = require('./flows/pasos')
const prepa = require('./flows/prepa')
const inscripcion = require('./flows/inscripcion')
const fechas = require('./flows/fechas')
const planes = require('./flows/planes')
const pago = require('./flows/pago')
const paypal = require('./flows/paypal')
const requisitos = require('./flows/requisitos')
const curso = require('./flows/curso')
...
const main = async () => {
    ...
    const adapterFlow = createFlow([hola, asesor, pasos, prepa, inscripcion, fechas, planes, pago, paypal, requisitos, curso, examen])
